...
export default function TextInput(_a) {
    ...
    var { label = "", prefix = "", numberOnly = false, showError = false, maxLength, required = false, type = "text", value: parentValue, onChange, onKeyDown, onError, onKeyUp, onFocus, onBlur, className = "" } = _a, props = __rest(_a, ["label", "prefix", "numberOnly", "showError", "maxLength", "required", "type", "value", "onChange", "onKeyDown", "onError", "onKeyUp", "onFocus", "onBlur", "className"]);
